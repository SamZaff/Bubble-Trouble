...
class SoundControl {
    ...
    void MusicStart(String song) {
        try {
            ...
            AIS = AudioSystem.getAudioInputStream(new File("Resources/" + song).getAbsoluteFile());
    ...
    void outPutAudio(String sfx, float freq) {
        ...
        try {
            AIS2 = AudioSystem.getAudioInputStream(new File("Resources/" + sfx).getAbsoluteFile());
